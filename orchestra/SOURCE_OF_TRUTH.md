...
All orchestra lanes must follow the same canonical priority order.
...
- relevant `outline/Vol_*`
- relevant `lore_bible/**`
- `lore_bible/Mandatory_Events.md`
- `lore_bible/Foreshadow_Payoff_Ledger.md`
- `lore_bible/Relationship_Map.md` when the work touches emotional drift
- `lore_bible/Supporting_Cast_Witness_Map.md` when side-character testimony matters
- `lore_bible/Front_Half_Foreshadow_Map.md` when clue density or fairness matters
- `lore_bible/Ending_Convergence_Map.md` when late reveals or endings are in scope
...
- relevant faction and location files
- relevant rule files
- `lore_bible/Mandatory_Events.md`
- `lore_bible/Foreshadow_Payoff_Ledger.md`
- `lore_bible/Supporting_Cast_Witness_Map.md` when side cast or faction witnesses are in play
- `lore_bible/Mid_War_Emotional_Continuity.md` when working in `Vol. 4~8`
- `lore_bible/history/Fixed_Point_Pressure_Map.md` when working on paradox structure
- `lore_bible/Ending_Convergence_Map.md` when the pass touches `Vol. 11~15`
- adjacent outlines and timelines

### Fixed-point or branch-pressure pass
...
- `lore_bible/Mandatory_Events.md`
- relevant `outline/Vol_*_Outline.md`
- relevant `outline/Vol_*_Timeline.md`
...
- `outline/Series_Roadmap.md`
- target outlines and timelines
- relevant character and lore files
- ending docs or reveal docs when applicable
...
- `lore_bible/Ending_Convergence_Map.md` when the reveal touches `Vol. 11~15`
