...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, plus `Vol.4 Chapters 1~15` are now style-locked complete with aggregate verification complete through `Vol.4 Chapters 11~15`.
...
- Current target: `Vol.4 Chapter 16`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, and Vol.4 Chapters 1~15 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, and `Vol.4 Chapters 1~15` verification are complete, so the next one-unit run is `Vol.4 Chapter 16`.
...
- Chapter 16 watch item: continue from Ch15 ruined-world leakage bridge. Protect Ch15's final Seraphim pull, black mark on Ria's blank record, delayed metal-shard sound, and Ch16's return/leakage opening.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.4 Chapter 16. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one chapter only: Drafts/Vol_4/Vol_4_Chapter_16.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, Drafts/Vol_4/Vol_4_Chapter_15.md as prior edge, Drafts/Vol_4/Vol_4_Chapter_16.md, Drafts/Vol_4/Vol_4_Chapter_17.md as right edge if present, Vol.4 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.4 Chapter 15 checkpoint, latest Vol.4 Chapters 11~15 aggregate checkpoint, and relevant canon/setting context. Run full read, specialist FAIL ledger with Hook/first-screen, Mid-pressure/scene-causality, Ending click, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Pay special attention to Ch15's Seraphim pull, Ria blank-record black mark, delayed metal-shard sound, and the Ch16 return/leakage opening. Apply narrow fixes only, reread the full chapter after any edit, then run final no-edit 5-cycle verification. Do not mark Chapter 16 style-locked complete unless all five verification cycles hold. After success, create/update the Chapter 16 checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin.`
<!-- stale-ch10-prompt
