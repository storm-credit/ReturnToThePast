...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, plus `Vol.4 Chapters 1~19` are now style-locked complete with aggregate verification complete through `Vol.4 Chapters 11~15`.
...
- Current target: `Vol.4 Chapter 20`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, and Vol.4 Chapters 1~19 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, and `Vol.4 Chapters 1~15` verification are complete, so the next one-unit run is `Vol.4 Chapter 20`.
- Last verified style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~19`.
...
- Latest checkpoint: `orchestra/VOL4_CHAPTER_19_STYLE_HARNESS_CHECKPOINT_2026-06-13.md`.
...
- Chapter 20 watch item: continue from Ch19's city-wide 전장 and `버는 건 된다 / 끝내는 건 안 된다` rule into the first 해방자 deployment. Protect that 해방자 buys minutes, not victory; it must leave bodily/name/hearing cost, fear instead of cheers, and increased future demand. After Ch20 passes, run the Vol.4 Chapters 16~20 aggregate before advancing to Ch21.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.4 Chapter 20. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one chapter only: Drafts/Vol_4/Vol_4_Chapter_20.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, Drafts/Vol_4/Vol_4_Chapter_19.md as prior edge, Drafts/Vol_4/Vol_4_Chapter_20.md, Drafts/Vol_4/Vol_4_Chapter_21.md as right edge if present, Vol.4 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.4 Chapter 19 checkpoint, latest Vol.4 Chapters 11~15 aggregate checkpoint, and relevant canon/setting context. Run full read, specialist FAIL ledger with Hook/first-screen, Mid-pressure/scene-causality, Ending click, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Pay special attention to Ch19's city-wide 전장, the rule that current tools only buy time, 해방자 as first deployment rather than triumph, and the need for visible bodily/identity cost plus fear instead of applause. Apply narrow fixes only, reread the full chapter after any edit, then run final no-edit 5-cycle verification. Do not mark Chapter 20 style-locked complete unless all five verification cycles hold. After success, create/update the Chapter 20 checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin. After Vol.4 Chapter 20 passes, the next unit must be the Vol.4 Chapters 16~20 aggregate verification packet before advancing to Vol.4 Chapter 21.`
<!-- stale-ch10-prompt
