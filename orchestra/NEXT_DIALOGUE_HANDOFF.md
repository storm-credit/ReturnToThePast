...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, plus `Vol.4 Chapters 1~10` are now style-locked complete with aggregate verification complete through `Vol.4 Chapters 1~5`.
...
- Active incomplete style-harness range: aggregate `Vol.4 Chapters 6~10`.
...
- Aggregate watch item: `Drafts/Vol_4/Vol_4_Chapter_6.md` through `Drafts/Vol_4/Vol_4_Chapter_10.md` must hold as one pressure packet: Ch6 north-east front diagnosis, Ch7 taboo-door proposal, Ch8 preparation and symptom record, Ch9 Iris/Ria pressure plus western-wall report, and Ch10 alliance logistics into Ch11's front-line mud. Do not advance to Vol.4 Chapter 11 before this aggregate packet passes.
- Exact next prompt override: `RTTP Style-Harness Recast aggregate Vol.4 Chapters 6~10. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one aggregate packet only: Drafts/Vol_4/Vol_4_Chapter_6.md through Drafts/Vol_4/Vol_4_Chapter_10.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, Drafts/Vol_4/Vol_4_Chapter_5.md as prior edge, Drafts/Vol_4/Vol_4_Chapter_6.md through Drafts/Vol_4/Vol_4_Chapter_10.md, Drafts/Vol_4/Vol_4_Chapter_11.md as right edge if present, Vol.4 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, checkpoints for Vol.4 Chapters 6~10, latest Vol.4 Chapters 1~5 aggregate checkpoint, and relevant canon/setting context. Run aggregate specialist FAIL ledger with cross-chapter hook/pressure ladder, mid-pressure/scene causality, ending-click into Chapter 11, time-scent/regression-route, motif overuse/style, clarity/canon continuity, style-harness fit, and length/format. Apply narrow fixes only if the packet fails, reread the full affected packet after any edit, then run final no-edit 5-cycle aggregate verification. Do not mark Vol.4 Chapters 6~10 aggregate complete unless all five verification cycles hold. After success, create/update the aggregate checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin. Next target after this aggregate passes is Vol.4 Chapter 11.`
<!-- stale-ch10-prompt
