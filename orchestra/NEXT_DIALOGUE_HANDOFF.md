...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, plus `Vol.4 Chapters 1~15` are now style-locked complete with aggregate verification complete through `Vol.4 Chapters 6~10`.
...
- Current target: `Vol.4 Chapters 11~15 aggregate`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, and Vol.4 Chapters 1~15 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, and `Vol.4 Chapters 1~10` verification are complete, so the next one-unit run is aggregate `Vol.4 Chapters 11~15`.
- Last verified style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~15`.
- Last verified aggregate style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~10`.
- Active incomplete style-harness range: `Vol.4 Chapters 11~15 aggregate`.
- Latest checkpoint: `orchestra/VOL4_CHAPTER_15_STYLE_HARNESS_CHECKPOINT_2026-06-06.md`.
- Latest aggregate checkpoint: `orchestra/VOL4_CHAPTER_6_10_STYLE_HARNESS_AGGREGATE_CHECKPOINT_2026-06-06.md`.
...
- Aggregate watch item: process `Vol.4 Chapters 11~15` as the next one-unit packet before `Vol.4 Chapter 16`. Verify the chain `Ch10 north-east/front-line proof -> Ch11 front-line losses -> Ch12 inner-room decision -> Ch13 sacrifice cost -> Ch14 anchored contact -> Ch15 ruined-world leakage bridge -> Ch16 return/leakage opening`; protect Ch15's final Seraphim pull, black mark on Ria's blank record, and delayed metal-shard sound.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.4 Chapters 11~15 aggregate. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one unit only: the aggregate packet Drafts/Vol_4/Vol_4_Chapter_11.md through Drafts/Vol_4/Vol_4_Chapter_15.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, Drafts/Vol_4/Vol_4_Chapter_10.md as prior edge, Drafts/Vol_4/Vol_4_Chapter_11.md through Drafts/Vol_4/Vol_4_Chapter_15.md, Drafts/Vol_4/Vol_4_Chapter_16.md as right edge if present, Vol.4 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.4 Chapter 11~15 checkpoints, latest Vol.4 Chapter 15 checkpoint, latest Vol.4 Chapters 6~10 aggregate checkpoint, and relevant canon/setting context. Run full aggregate read, specialist FAIL ledger with cross-chapter Hook/pressure ladder, Mid-pressure/scene-causality, Ending click into Chapter 16, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Apply no manuscript edits unless the aggregate pass finds a real blocker; if a repair is needed, edit narrowly, reread the full packet, then run final no-edit 5-cycle aggregate verification. Do not mark Vol.4 Chapters 11~15 aggregate complete unless all five verification cycles hold. After success, create/update the aggregate checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin. Only after this aggregate passes may the next one-unit run advance to Vol.4 Chapter 16.`
<!-- stale-ch10-prompt
