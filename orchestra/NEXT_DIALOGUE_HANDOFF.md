...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, `Vol.4 Chapters 1~25`, `Vol.5 Chapters 1~25`, plus `Vol.6 Chapters 1~25` are now style-locked complete; aggregate verification is contiguous through `Vol.6 Chapters 1~20`.
...
- Current target: aggregate `Vol.6 Chapters 21~25`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, Vol.4 Chapters 1~25, Vol.5 Chapters 1~25, and Vol.6 Chapters 1~25 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, `Vol.4 Chapters 1~25`, `Vol.5 Chapters 1~25`, and `Vol.6 Chapters 1~20` verification are complete. The next required unit is aggregate `Vol.6 Chapters 21~25`. Do not resume the older Vol.6/overall-147 re-deep-lock queue.
- Last verified style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~25; Vol.5 Chapters 1~25; Vol.6 Chapters 1~25`.
...
- Active incomplete style-harness range: aggregate `Vol.6 Chapters 21~25`.
- Latest checkpoint: `orchestra/VOL6_CHAPTER_25_STYLE_HARNESS_CHECKPOINT_2026-06-19.md`.
...
- Additional supersession note: `Vol.6 Chapter 25` has now passed; the aggregate `Vol.6 Chapters 21~25` prompt below is the only active next prompt. Aggregate verification remains contiguous through `Vol.6 Chapters 1~20`.
- Vol.6 Chapters 21~25 aggregate watch item: read Vol.6 Ch20 as prior edge, Ch21~Ch25 as the full packet, and `Drafts/Vol_7/Vol_7_Chapter_1.md` as next-volume right edge if present. Prove the arc from Ch21 `그림자 사냥` through Ch22 proposal, Ch23 name-call, Ch24 threshold decision, and Ch25 tower first cell without spending Vol7's `빌린 아침` borrowed-morning loop.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.6 Chapters 21~25 aggregate. Existing Vol.6/147 re-deep-lock queue is not the active queue; continue the style-recast queue. Process exactly one aggregate packet only: Drafts/Vol_6/Vol_6_Chapter_21.md through Drafts/Vol_6/Vol_6_Chapter_25.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, EXECUTION_PROGRESS_LEDGER, Drafts/Vol_6/Vol_6_Chapter_20.md as prior edge, Drafts/Vol_6/Vol_6_Chapter_21.md through Drafts/Vol_6/Vol_6_Chapter_25.md, Drafts/Vol_7/Vol_7_Chapter_1.md as next-volume right edge if present, Vol.6 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.6 Chapter 21~25 single-chapter checkpoints, latest Vol.6 Chapters 16~20 aggregate checkpoint, and relevant canon/setting context. Run full packet read, specialist FAIL ledger with Hook/packet entry, Pressure ladder, Scene causality, Ending bridge, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Pay special attention to Ch21 shadow-hunt aftermath, Ch22 Baltazar proposal, Ch23 Hyoo-young name-call, Ch24 threshold decision, Ch25 tower first cell, and preserving Vol7 Ch1 as right-edge material only. Apply only narrow fixes if required, reread the full packet after any edit, then run final no-edit 5-cycle aggregate verification. Do not mark Vol.6 Chapters 21~25 aggregate locked complete unless all five verification cycles hold. After success, create/update `orchestra/VOL6_CHAPTER_21_25_STYLE_HARNESS_AGGREGATE_CHECKPOINT_2026-06-19.md`, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, set the next unit to Vol.7 Chapter 1, stage only relevant changed files, commit clearly, and push current branch to origin. Preserve unrelated dirty worktree changes.`
