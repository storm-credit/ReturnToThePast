...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, `Vol.4 Chapters 1~25`, plus `Vol.5 Chapters 1~6` are now style-locked complete with aggregate verification complete through `Vol.5 Chapters 1~5`.
...
- Current target: `Vol.5 Chapter 7`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, Vol.4 Chapters 1~25, and Vol.5 Chapters 1~6 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, `Vol.4 Chapters 1~25`, and `Vol.5 Chapters 1~5` verification are complete, so the next one-unit run is `Vol.5 Chapter 7`.
- Last verified style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~25; Vol.5 Chapters 1~6`.
...
- Latest checkpoint: `orchestra/VOL5_CHAPTER_6_STYLE_HARNESS_CHECKPOINT_2026-06-13.md`.
...
-->
- Supersession note: use the final exact next prompt override in this active block; any earlier Chapter 8, Vol.3 aggregate, Vol.4 aggregate, Vol.5 Chapter 5, Vol.5 Chapters 1~5 aggregate, or Vol.5 Chapter 6 prompt line in this block is stale historical text.
- Vol.5 Chapter 7 watch item: read Vol.5 Ch6 as prior edge, Ch7 as the target, and Vol.5 Ch8 as right edge if present. Carry forward Ch6's black-night antibody swarm, medicine and ether loss, recovery delay, colder next-night chart, and the public gap widening around Aiden. Ch7 must make supply pressure, triage resentment, and depleted medicine/ether feel like the aftermath of Ch6 rather than a fresh logistics reset; preserve the bridge toward Ch8's desert/rear-defense pressure if present. Preserve unrelated dirty worktree changes; only Ch7-relevant manuscript/checkpoint/state/handoff/ledger changes should be staged.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.5 Chapter 7 진행. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one chapter only: Drafts/Vol_5/Vol_5_Chapter_7.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, EXECUTION_PROGRESS_LEDGER, Drafts/Vol_5/Vol_5_Chapter_6.md as prior edge, Drafts/Vol_5/Vol_5_Chapter_7.md, Drafts/Vol_5/Vol_5_Chapter_8.md as right edge if present, Vol.5 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.5 Chapter 6 checkpoint, latest Vol.5 Chapters 1~5 aggregate checkpoint, and relevant canon/setting context. Run full read, specialist FAIL ledger with Hook/first-screen, Mid-pressure/scene-causality, Ending click, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Pay special attention to Ch6 medicine/ether losses, public gap around Aiden, colder placement charts, and Ch7 supply-pressure/resentment bridge toward Ch8. Apply narrow fixes only if required, reread the full chapter after any edit, then run final no-edit 5-cycle verification. Do not mark Vol.5 Chapter 7 style-locked complete unless all five verification cycles hold. After success, create/update the Chapter 7 checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin.`
