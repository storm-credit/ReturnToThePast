...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, plus `Vol.3 Chapters 1~25` are now style-locked complete with aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~5`, `Vol.2 Chapters 6~10`, `Vol.2 Chapters 11~15`, `Vol.2 Chapters 16~20`, `Vol.2 Chapters 21~25`, `Vol.3 Chapters 1~5`, `Vol.3 Chapters 6~10`, `Vol.3 Chapters 11~15`, and `Vol.3 Chapters 16~20` verification complete.
...
- Current target: aggregate `Vol.3 Chapters 21~25`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, and Vol.3 Chapters 1~25 are style-locked complete under the new sample-derived style harness; aggregate `Vol.3 Chapters 1~5`, `Vol.3 Chapters 6~10`, `Vol.3 Chapters 11~15`, and `Vol.3 Chapters 16~20` are complete, so the next unit is aggregate verification for Vol.3 Chapters 21~25.
- Last verified style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25`.
- Last verified aggregate style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~20`.
- Active incomplete style-harness range: aggregate `Vol.3 Chapters 21~25`.
- Latest checkpoint: `orchestra/VOL3_CHAPTER_25_STYLE_HARNESS_CHECKPOINT_2026-06-06.md`.
- Latest aggregate checkpoint: `orchestra/VOL3_CHAPTER_16_20_STYLE_HARNESS_AGGREGATE_CHECKPOINT_2026-06-06.md`.
...
- Exact next prompt override: `RTTP Style-Harness Recast aggregate Vol.3 Chapters 21~25 proceed. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one unit only: aggregate packet verification for Drafts/Vol_3/Vol_3_Chapter_21.md through Drafts/Vol_3/Vol_3_Chapter_25.md. Do not advance to Vol.4 Chapter 1 during this run. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, Drafts/Vol_3/Vol_3_Chapter_20.md as left edge, Drafts/Vol_3/Vol_3_Chapter_21.md through Drafts/Vol_3/Vol_3_Chapter_25.md, Drafts/Vol_4/Vol_4_Chapter_1.md as right edge if relevant/present, Vol.3 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, relevant pressure grid if available, tone/style guidance, the latest Vol.3 Chapters 16~20 aggregate checkpoint, the Vol.3 Chapter 21~25 single-chapter checkpoints, and relevant canon/setting context. Run full packet read, aggregate specialist FAIL ledger with cross-chapter Hook/pressure ladder, Scene-causality, Ending click into Vol.4, Time-scent/regression-route guard, Motif-overuse/style guard, Clarity/canon-continuity guard, Style-harness fit, and Length/format. Apply no manuscript edits unless the aggregate verification exposes a concrete blocker; if edits are needed, keep them narrow and reread the whole affected packet. Do not mark the aggregate style-locked complete unless all five final no-edit verification cycles hold. After success, create/update the Vol.3 Chapters 21~25 aggregate checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin. After this aggregate passes, the next unit becomes Vol.4 Chapter 1.`
