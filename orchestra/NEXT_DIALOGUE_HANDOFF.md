...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, plus `Vol.4 Chapters 1~24` are now style-locked complete with aggregate verification complete through `Vol.4 Chapters 16~20`.
...
- Current target: `Vol.4 Chapter 25`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, and Vol.4 Chapters 1~24 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, and `Vol.4 Chapters 1~20` verification are complete, so the next one-unit run is `Vol.4 Chapter 25`.
- Last verified style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~24`.
- Last verified aggregate style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~20`.
- Active incomplete style-harness range: `none`.
- Latest checkpoint: `orchestra/VOL4_CHAPTER_24_STYLE_HARNESS_CHECKPOINT_2026-06-13.md`.
...
- Chapter 25 watch item: Ch25 starts after Ch24's 부적 is received, constrained, and explicitly framed as not a clean gift or power-up. It must carry the charm as a burden Aiden intends not to use while the march, supply carts, rear-line medicine, and evacuation pressure make that intention immediately testable. Preserve that Ch25 is the Vol.4 exit: the army moves with ledgers, bandages, carts, and aliases, and the rear-line signal should make the next aggregate packet's Ch21~25 arc visible before any advance beyond Vol.4.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.4 Chapter 25. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one chapter only: Drafts/Vol_4/Vol_4_Chapter_25.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, Drafts/Vol_4/Vol_4_Chapter_24.md as prior edge, Drafts/Vol_4/Vol_4_Chapter_25.md, Drafts/Vol_5/Vol_5_Chapter_1.md as next-volume right edge if present, Vol.4 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.4 Chapter 24 checkpoint, latest Vol.4 Chapters 16~20 aggregate checkpoint, and relevant canon/setting context. Run full read, specialist FAIL ledger with Hook/first-screen, Mid-pressure/scene-causality, Ending click, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Pay special attention to Ch24's 부적 cost gate, the prohibition/exception record lines, Aiden's stated intention not to use it, and the transition into Ch25's 진격 with supply carts, rear-line medicine, evacuation pressure, and the first rear-signal test. Apply narrow fixes only, reread the full chapter after any edit, then run final no-edit 5-cycle verification. Do not mark Vol.4 Chapter 25 style-locked complete unless all five verification cycles hold. After success, create/update the Chapter 25 checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin. After Vol.4 Chapter 25 passes, the next unit must be the aggregate Vol.4 Chapters 21~25 verification packet before advancing beyond Vol.4.`
<!-- stale-ch10-prompt
