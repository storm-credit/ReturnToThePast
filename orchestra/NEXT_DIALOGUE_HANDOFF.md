...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, plus `Vol.4 Chapters 1~20` are now style-locked complete with aggregate verification complete through `Vol.4 Chapters 11~15`.
...
- Current target: `Vol.4 Chapters 16~20 aggregate`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, and Vol.4 Chapters 1~20 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, and `Vol.4 Chapters 1~15` verification are complete, so the next one-unit run is `Vol.4 Chapters 16~20 aggregate`. Do not advance to `Vol.4 Chapter 21` until this aggregate packet passes.
- Last verified style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~20`.
- Last verified aggregate style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~15`.
- Active incomplete style-harness range: `none`.
- Latest checkpoint: `orchestra/VOL4_CHAPTER_20_STYLE_HARNESS_CHECKPOINT_2026-06-13.md`.
- Latest aggregate checkpoint: `orchestra/VOL4_CHAPTER_11_15_STYLE_HARNESS_AGGREGATE_CHECKPOINT_2026-06-11.md`.
...
- Aggregate 16~20 watch item: verify the five-chapter chain from Ch16 present-world leakage -> Ch17 first human casualty/north-gate 봉쇄 -> Ch18 항체 contact-tracking -> Ch19 city-wide 전장/logistics collapse -> Ch20 first 해방자 deployment. Protect that 해방자 buys minutes, not victory; the packet must hold bodily/name/hearing cost, fear instead of cheers, and rising future demand. Do not advance to Ch21 until this aggregate is locked complete.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.4 Chapters 16~20 aggregate. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one aggregate packet only: Drafts/Vol_4/Vol_4_Chapter_16.md through Drafts/Vol_4/Vol_4_Chapter_20.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, Drafts/Vol_4/Vol_4_Chapter_15.md as prior edge, Drafts/Vol_4/Vol_4_Chapter_16.md through Drafts/Vol_4/Vol_4_Chapter_20.md, Drafts/Vol_4/Vol_4_Chapter_21.md as right edge if present, Vol.4 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.4 Chapter 16 through Chapter 20 checkpoints, latest Vol.4 Chapters 11~15 aggregate checkpoint, and relevant canon/setting context. Run full packet read, specialist FAIL ledger with Hook/packet entry, Pressure ladder, Scene causality, Ending bridge, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Apply no manuscript edits unless an aggregate blocker requires a narrow fix; after any edit, reread the full affected chapter and full aggregate packet. Then run final no-edit 5-cycle aggregate verification. Do not mark Vol.4 Chapters 16~20 aggregate locked complete unless all five cycles hold. After success, create/update the aggregate checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin. Do not advance to Vol.4 Chapter 21 until this aggregate passes.`
<!-- stale-ch10-prompt
