...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, plus `Vol.4 Chapters 1~12` are now style-locked complete with aggregate verification complete through `Vol.4 Chapters 6~10`.
...
- Current target: `Vol.4 Chapter 13`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, and Vol.4 Chapters 1~12 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, and `Vol.4 Chapters 1~10` verification are complete, so the next one-unit run is `Vol.4 Chapter 13`.
- Last verified style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~12`.
...
- Active incomplete style-harness range: `Vol.4 Chapter 13`.
- Latest checkpoint: `orchestra/VOL4_CHAPTER_12_STYLE_HARNESS_CHECKPOINT_2026-06-06.md`.
...
- Chapter 13 watch item: preserve Ch12's final symptom-board blank cell and `what will be taken` pressure into Ch13's ritual-prep room and `수명 3년` reveal. Normalize the bare title `제물`, remove in-world backticks, and keep the sacrifice language bodily/procedural rather than gore, game, or checklist surface.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.4 Chapter 13. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one chapter only: Drafts/Vol_4/Vol_4_Chapter_13.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, Drafts/Vol_4/Vol_4_Chapter_12.md as prior edge, Drafts/Vol_4/Vol_4_Chapter_13.md, Drafts/Vol_4/Vol_4_Chapter_14.md as right edge if present, Vol.4 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.4 Chapter 12 checkpoint, latest Vol.4 Chapters 6~10 aggregate checkpoint, and relevant canon/setting context. Run full read, specialist FAIL ledger with Hook/first-screen, Mid-pressure/scene-causality, Ending click, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Pay special attention to Ch12's blank-cell ending, Ch13's ritual-prep object sequence, the 수명 3년 cost reveal, the bare title/backticks, and any checklist/game-like procedure wording. Apply narrow fixes only, reread the full chapter after any edit, then run final no-edit 5-cycle verification. Do not mark Vol.4 Chapter 13 style-locked complete unless all five verification cycles hold. After success, create/update the Chapter 13 checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin. Aggregate Vol.4 Chapters 11~15 is due after Vol.4 Chapter 15 passes.`
<!-- stale-ch10-prompt
