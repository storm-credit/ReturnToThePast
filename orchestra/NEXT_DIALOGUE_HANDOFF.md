...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, plus `Vol.4 Chapters 1~3` are now style-locked complete with aggregate verification complete through `Vol.3 Chapters 21~25`.
...
- Current target: `Vol.4 Chapter 4`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, and Vol.4 Chapters 1~3 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, and `Vol.3 Chapters 1~25` verification are complete, so the next unit is `Vol.4 Chapter 4`.
- Last verified style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~3`.
- Last verified aggregate style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25`.
- Active incomplete style-harness range: `Vol.4 Chapter 4`.
- Latest checkpoint: `orchestra/VOL4_CHAPTER_3_STYLE_HARNESS_CHECKPOINT_2026-06-06.md`.
...
- Exact next prompt override: `RTTP Style-Harness Recast Vol.4 Chapter 4 proceed. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one chapter only: Drafts/Vol_4/Vol_4_Chapter_4.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, Drafts/Vol_4/Vol_4_Chapter_3.md as left edge, Drafts/Vol_4/Vol_4_Chapter_4.md, Drafts/Vol_4/Vol_4_Chapter_5.md if present as right edge, Vol.4 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, relevant pressure grid if available, tone/style guidance, latest Vol.4 Chapter 3 checkpoint, latest Vol.3 Chapters 21~25 aggregate checkpoint, and relevant canon/setting context. Run full read, specialist FAIL ledger with Hook/first-screen, Mid-pressure/scene-causality, Ending click/next-episode force, Time-scent/regression-route guard, Motif-overuse/style guard, Clarity/canon-continuity guard, Style-harness fit, and Length/format. Apply narrow fixes only, reread the full chapter, then run final no-edit 5-cycle verification. Do not mark Chapter 4 style-locked complete unless all five verification cycles hold. After success, create/update the Vol.4 Chapter 4 checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin. Aggregate Vol.4 Chapters 1~5 is due after Vol.4 Chapter 5 passes.`
