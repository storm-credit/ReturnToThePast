...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, `Vol.4 Chapters 1~25`, `Vol.5 Chapters 1~25`, plus `Vol.6 Chapters 1~20` are now style-locked complete; aggregate verification is contiguous through `Vol.6 Chapters 1~20`.
...
- Current target: `Vol.6 Chapter 21`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, Vol.4 Chapters 1~25, Vol.5 Chapters 1~25, and Vol.6 Chapters 1~20 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, `Vol.4 Chapters 1~25`, `Vol.5 Chapters 1~25`, and `Vol.6 Chapters 1~20` verification are complete. The next required unit is `Vol.6 Chapter 21`. Do not resume the older Vol.6/overall-147 re-deep-lock queue.
...
- Additional supersession note: aggregate `Vol.6 Chapters 16~20` has now passed; that aggregate prompt is stale and the Chapter 21 prompt below is the only active next prompt.
- Vol.6 Chapter 21 watch item: read Vol.6 Ch20 as prior edge, Ch21 as target, and Ch22 as right edge if present. Ch21 must spend Ch20's single moving shadow into `그림자 사냥` repeated pursuit/measurement pressure while preserving Ch22's `발타자르의 제안` tower-proposal packet.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.6 Chapter 21 진행. Existing Vol.6/147 re-deep-lock queue is not the active queue; continue the style-recast queue. Process exactly one chapter only: Drafts/Vol_6/Vol_6_Chapter_21.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, EXECUTION_PROGRESS_LEDGER, Drafts/Vol_6/Vol_6_Chapter_20.md as prior edge, Drafts/Vol_6/Vol_6_Chapter_21.md, Drafts/Vol_6/Vol_6_Chapter_22.md as right edge if present, Vol.6 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.6 Chapter 20 style checkpoint, latest Vol.6 Chapters 16~20 aggregate checkpoint, and relevant canon/setting context. Run full read, specialist FAIL ledger with Hook/first-screen, Mid-pressure/scene-causality, Ending click, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Pay special attention to Ch20 enemy-trap/capture-reading handoff, Ch21 `그림자 사냥` escalation, and preserving Ch22's `발타자르의 제안` / time-tower proposal payload. Apply only narrow fixes if required, reread fully after any edit, then run final no-edit 5-cycle verification. Do not mark Vol.6 Chapter 21 style-locked complete unless all five verification cycles hold. After success, create/update the Chapter 21 checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, set the next unit to Vol.6 Chapter 22, stage only relevant changed files, commit clearly, and push current branch to origin. Preserve unrelated dirty worktree changes.`
