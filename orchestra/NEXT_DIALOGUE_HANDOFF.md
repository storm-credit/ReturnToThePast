...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, `Vol.4 Chapters 1~25`, `Vol.5 Chapters 1~25`, `Vol.6 Chapters 1~25`, plus `Vol.7 Chapters 1~25` are now style-locked complete; aggregate verification is contiguous through `Vol.7 Chapters 1~10`.
...
- Current target: `Vol.7 Chapters 11~15 aggregate`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, Vol.4 Chapters 1~25, Vol.5 Chapters 1~25, Vol.6 Chapters 1~25, and Vol.7 Chapters 1~25 are style-locked complete under the new sample-derived style harness; aggregate verification is complete and contiguous through `Vol.7 Chapters 1~10`. The next required unit is exactly one aggregate packet, `Vol.7 Chapters 11~15 aggregate`. Do not resume the older Vol.6/overall-147 re-deep-lock queue and do not advance to Vol.8 before the due Vol.7 aggregates.
- Last verified style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~25; Vol.5 Chapters 1~25; Vol.6 Chapters 1~25; Vol.7 Chapters 1~25`.
- Last verified aggregate style-harness range: `Vol.1 Chapters 1~25; Vol.2 Chapters 1~25; Vol.3 Chapters 1~25; Vol.4 Chapters 1~25; Vol.5 Chapters 1~25; Vol.6 Chapters 1~25; Vol.7 Chapters 1~10`.
- Active incomplete style-harness range: `Vol.7 Chapters 11~15 aggregate`.
- Latest checkpoint: `orchestra/VOL7_CHAPTER_25_STYLE_HARNESS_CHECKPOINT_2026-06-26.md`.
- Latest aggregate checkpoint: `orchestra/VOL7_CHAPTER_6_10_STYLE_HARNESS_AGGREGATE_CHECKPOINT_2026-06-26.md`.
...
- Additional supersession note: `Vol.7 Chapters 6~10 aggregate` has now passed after one Ch6-only surface repair; the `Vol.7 Chapters 11~15 aggregate` prompt below is the only active next prompt. Individual Vol.7 chapters are style-locked through Ch25, while aggregate verification is contiguous through `Vol.7 Chapters 1~10`.
- Vol.7 Chapters 11~15 aggregate watch item: read Vol.7 Ch10 as prior edge, Vol.7 Ch11~15 as the target packet, and Vol.7 Ch16 as right edge. The aggregate must prove the ladder from Ch10's wrong-knock bridge -> Ch11 wrong-rhythm/card/observer threshold -> Ch12 formal structure response/document classification -> Ch13 bakery/호명 contact and empty-slot proof -> Ch14 response-price/number-slip aftershock -> Ch15 first failed survivor/west-well/night-call warning. Preserve Ch16's `두 번째 종` refusal/cost-of-not-going lane, Ch17's condition-setting lane, Ch18's first-laughter lane, and later 1847/1848 endgame material. Do not edit Vol.8 or advance to Vol.8 before due Vol.7 aggregates are complete.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.7 Chapters 11~15 aggregate. Existing Vol.6/147 re-deep-lock queue is not the active queue; continue the style-recast queue. Process exactly one aggregate packet only: Drafts/Vol_7/Vol_7_Chapter_11.md through Drafts/Vol_7/Vol_7_Chapter_15.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, EXECUTION_PROGRESS_LEDGER, Drafts/Vol_7/Vol_7_Chapter_10.md as prior edge, Drafts/Vol_7/Vol_7_Chapter_11.md through Drafts/Vol_7/Vol_7_Chapter_15.md, Drafts/Vol_7/Vol_7_Chapter_16.md as right edge if present, Vol.7 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.7 Chapter 11~15 single-chapter checkpoints, latest Vol.7 Chapter 25 checkpoint, latest Vol.7 Chapters 6~10 aggregate checkpoint, and relevant canon/setting context. Run full packet read, specialist FAIL ledger with Hook/packet entry, Pressure ladder, Scene causality, Ending bridge, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Pay special attention to the packet arc from wrong-knock/card/observer pressure through structure response, 호명, response-price, and the failed-survivor west-well warning; reserve Ch16's second-bell refusal lane and later Vol.7 endgame payload. Apply only narrow fixes if required, reread the full packet after any edit, then run final no-edit 5-cycle aggregate verification. Do not mark Vol.7 Chapters 11~15 aggregate locked complete unless all five verification cycles hold. After success, create/update the aggregate checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin. Preserve unrelated dirty worktree changes.`
