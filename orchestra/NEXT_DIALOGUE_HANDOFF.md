...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, plus `Vol.4 Chapters 1~20` are now style-locked complete with aggregate verification complete through `Vol.4 Chapters 16~20`.
...
- Current target: `Vol.4 Chapter 21`.
- Current status: Vol.1 Chapters 1~25, Vol.2 Chapters 1~25, Vol.3 Chapters 1~25, and Vol.4 Chapters 1~20 are style-locked complete under the new sample-derived style harness; aggregate `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, and `Vol.4 Chapters 1~20` verification are complete, so the next one-unit run is `Vol.4 Chapter 21`.
...
- Chapter 21 watch item: Ch21 starts after Ch20's first 해방자 deployment and the locked Ch16~20 aggregate. It must carry immediate value marks: body/name/count/hearing/sight cost, companion/public reaction, rumor pressure, fear instead of triumph, and rising demand for future use. Treat any right-edge record-line formatting residue in Ch21 as a target-file issue for the Ch21 pass, not as prior aggregate debt.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.4 Chapter 21. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one chapter only: Drafts/Vol_4/Vol_4_Chapter_21.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, Drafts/Vol_4/Vol_4_Chapter_20.md as prior edge, Drafts/Vol_4/Vol_4_Chapter_21.md, Drafts/Vol_4/Vol_4_Chapter_22.md as right edge if present, Vol.4 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.4 Chapter 20 checkpoint, latest Vol.4 Chapters 16~20 aggregate checkpoint, and relevant canon/setting context. Run full read, specialist FAIL ledger with Hook/first-screen, Mid-pressure/scene-causality, Ending click, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Pay special attention to Ch20 해방자 first use, body/name/hearing/sight cost, rumor/meaning pressure, public fear, and no miracle/free-solution framing. Apply narrow fixes only, reread the full chapter after any edit, then run final no-edit 5-cycle verification. Do not mark Vol.4 Chapter 21 style-locked complete unless all five verification cycles hold. After success, create/update the Chapter 21 checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin. Aggregate Vol.4 Chapters 21~25 remains due after Vol.4 Chapter 25 passes.`
<!-- stale-ch10-prompt
