...
- Work summary: sample-derived style rules have been added to the RTTP harness, and `Vol.1 Chapters 1~25`, `Vol.2 Chapters 1~25`, `Vol.3 Chapters 1~25`, `Vol.4 Chapters 1~25`, plus `Vol.5 Chapters 1~5` are now style-locked complete with aggregate verification complete through `Vol.5 Chapters 1~5`.
...
-->
- Supersession note: use the final exact next prompt override in this active block; any earlier Chapter 8, Vol.3 aggregate, Vol.4 aggregate, Vol.5 Chapter 5, or Vol.5 Chapters 1~5 aggregate prompt line in this block is stale historical text.
- Vol.5 Chapter 6 watch item: read Vol.5 Ch5 as prior edge, Ch6 as the target, and Vol.5 Ch7 as right edge if present. Carry forward Ch5's widened night spacing, two-line fire rule, empty-tent bait, central 3rd barricade ban, and people stepping away from Aiden. Ch6 must pay off the black-night antibody swarm, user-adjacent item reaction, recovery/medicine losses, and widening social gap without turning the antibodies into ordinary monsters or Aiden's knowledge into clean route logic. Preserve unrelated dirty worktree changes; only Ch6-relevant manuscript/checkpoint/state/handoff/ledger changes should be staged.
- Exact next prompt override: `RTTP Style-Harness Recast Vol.5 Chapter 6 진행. Existing Vol.6/147 queue is not the active queue; continue the style-recast queue. Process exactly one chapter only: Drafts/Vol_5/Vol_5_Chapter_6.md. Read SESSION_STATE, NEXT_DIALOGUE_HANDOFF, EXECUTION_PROGRESS_LEDGER, Drafts/Vol_5/Vol_5_Chapter_5.md as prior edge, Drafts/Vol_5/Vol_5_Chapter_6.md, Drafts/Vol_5/Vol_5_Chapter_7.md as right edge if present, Vol.5 outline/timeline, RTTP_ENGINE, Chapter_Audit_Checklist, Prompt_Quick_Reference, Writing_Prompt_Template, Banned_Surface_Ledger, Time_Travel_Frame, tone/style guidance, latest Vol.5 Chapter 5 checkpoint, latest Vol.5 Chapters 1~5 aggregate checkpoint, and relevant canon/setting context. Run full read, specialist FAIL ledger with Hook/first-screen, Mid-pressure/scene-causality, Ending click, Time-scent/regression-route, Motif overuse/style, Clarity/canon-continuity, Style-harness fit, and Length/format. Pay special attention to Ch5 empty-tent bait/night spacing and Ch6 antibody swarm, public gap around Aiden, medicine/ether losses, and the right-edge bridge into Ch7 supply pressure. Apply narrow fixes only if required, reread the full chapter after any edit, then run final no-edit 5-cycle verification. Do not mark Vol.5 Chapter 6 style-locked complete unless all five verification cycles hold. After success, create/update the Chapter 6 checkpoint, SESSION_STATE, NEXT_DIALOGUE_HANDOFF, and EXECUTION_PROGRESS_LEDGER, stage only relevant changed files, commit clearly, and push current branch to origin.`
