...
- Target volume/chapter: `Vol.4 Chapter 20 onward`
...
## Next Step
- draft `Vol.4 Chapter 24`, then run the hard length gate, chapter audit, and the next checkpoint before counting progress.
