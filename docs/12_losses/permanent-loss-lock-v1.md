...
|---|---|---|---|---|---|---|
| L001 | 세렌 바일 (C06) | E024 부근 | 에이든이 불완전 기록을 믿고 직접 살해 | 그의 개혁 의제가 후대 기록·잔문에 잔흔으로만 | 재시도·부활·다른 버전 대체 금지 | `LOCK` L001, `CAST` C06, `V01` |
...
|---|---|---|---|
| 미래 멸망 | 세렌 바일 사망 + F0 관계 다수 소실 | E023–E025 | `V01`, `LOCK` L001, L002 |
...
- 세렌 바일(C06) 사망의 정확한 화수. LOCK은 E023–E025, cast-canon-index-v2.md는 'E024 부근'으로만 기재되어 있어 단일 화로 확정할 근거가 없다.
