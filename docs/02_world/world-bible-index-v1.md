...
이 세계에서 역사는 과거에 대한 설명이 아니라 사람·땅·계절·소유권을 현재에 고정하는 공공 기반시설이다. 마법은 개인 재능만으로 안정되지 않고 물질, 기억, 공적 기록, 반복된 관습, 장소가 서로 일치할 때 지속된다. 칼레온 왕관령의 시간장치는 이 원리를 문명 전체 규모로 확장한 분산 시스템이며, 중앙의 번영은 지방·종족·움브라에게 전가된 비용과 연결된다.
