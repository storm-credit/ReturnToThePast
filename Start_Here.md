...
17. **[설정집 종료 판정](orchestra/SETTING_CLOSURE_DECISION_2026-04-09.md)**
    *   설정집이 더 이상 필수 보강을 요구하지 않고 종료 가능 상태라는 총괄 판정 문서.
18. **[전문가 최종 잠금 라운드](orchestra/EXPERT_LOCK_ROUND_2026-04-09.md)**
    *   시간법칙, 마법/몬스터, 인물/배경, 프로듀서 축 전문가들이 `GO`를 준 최종 잠금 기록.
19. **[집필 엔진 GO 판정](orchestra/ENGINE_DRAFT_GO_DECISION_2026-04-09.md)**
    *   RTTP 엔진이 하네스 구조 기준으로 집필 시작에 충분하다는 최종 점검 문서.
20. **[엔진 전문가 잠금](orchestra/ENGINE_EXPERT_LOCK.md)**
    *   작문법 전문가가 누구이고, 어떤 상황에서 어떤 작문법을 맡는지 고정한 엔진 roster.
21. **[제2권 → 제3권 브리지 감사](orchestra/VOL2_TO_VOL3_BRIDGE_AUDIT_2026-04-09.md)**
    *   제2권 말미의 공허와 과부하가 제3권 초반 압력으로 자연스럽게 이어지도록 잠근 브리지 문서.
22. **[제3권 제1화 실행 패킷](orchestra/packets/Vol_3_Chapter_1_Launch_Packet.md)**
    *   제3권 시작이 새 판처럼 보이지 않게, 반작용과 과부하를 첫 화에 어떻게 실을지 잠근 패킷.
